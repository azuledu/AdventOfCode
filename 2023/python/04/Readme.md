...
You discover dozens of scratchcards, all with their opaque covering already scratched off. 
Picking one up, it looks like each card has two lists of numbers separated by a vertical bar (|): a list of winning 
...
_Your puzzle answer was 24160._

### Part Two

You realizes that the rules have actually been printed on the back of every card this whole time.
